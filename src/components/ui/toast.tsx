...
>(({ className, variant, children, ...props }, ref) => {
    const icon = React.useMemo(() => {
        switch (variant) {
            case "success":
                return <CircleCheck className="mr-1 w-11 h-11 text-green-600 dark:text-white" />;
            case "warning":
                return <CircleAlert className="mr-1 w-11 h-11 text-orange-600 dark:text-white" />;
            case "info":
                return <Info className="mr-1 w-11 h-11 text-gray-600 dark:text-white" />;
            case "error":
                return <CircleX className="mr-1 w-11 h-11 text-red-600 dark:text-white" />;
            default:
                return null;
        }
    }, [variant]);
